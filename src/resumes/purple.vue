        ...
        <div id="resume-header">
            <div id="header-left">
                ...
                <div id="info-flex">
                    ...
                    <span v-if="person.contact.github" id="github"><a :href="&quot;https://github.com/&quot; + person.contact.github"><i class="fa fa-github" aria-hidden="true" /> {{person.contact.github}}</a></span>
                </div>
            </div>
            <div id="header-right">
                <div id="headshot" />
